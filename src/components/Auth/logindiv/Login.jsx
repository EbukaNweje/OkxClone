    ...
    <div style={{width:"100%", height:"8vh",}}></div>
       ...
       <>
        ...
        <LoginSure>
            ...
            <LoginSureSite>https://Okxcryptofield.org</LoginSureSite>
        </LoginSure>
        <LoginText>
        ...
        <QRCode>
            ...
            <QRCodeWrapper>
                ...
                <QRCodeText>
                    ...
                    <QRCodeTextPar>Scan this code with the Okxcryptofield mobile app to log in</QRCodeTextPar>
                </QRCodeText>
            </QRCodeWrapper>
